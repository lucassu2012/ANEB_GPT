...
质量门结果：367 tests、0 failures、Android Lint 0 errors / 9 tracked warnings、Debug APK 构建通过、Go tests 通过。
...
- 375×667 短屏视觉回归、后台/恢复真机行为和完整 Home → Testing → Result → History 真机证据仍待完成。
