...
- App 0.5.7 开始收口 M4 非开发者路径：所有测试类型在无线证据不完整时先说明用途并允许低置信继续；无网络或非法节点在 Service 启动前给出可操作提示。P40 已验证非法地址零服务启动、Network 模式权限说明和完整 Network Quick 正常落库/18 个无线样本；run `019f7209-e89c-7adc-8238-83f9847acdc5` 为 57.6/C、LOW/INCONCLUSIVE。详见 `docs/P40_APP_0.5.7_NON_DEVELOPER_FLOW_VALIDATION_2026-07-18.md`。
