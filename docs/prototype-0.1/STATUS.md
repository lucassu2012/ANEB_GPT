...
| G3 — Fixed Windows package | `PENDING` | issue #17 P0 HOLD; package-identity focused candidate GREEN but uncommitted | self-contained candidate launches from fresh directory |
...
| #17 | release/packaging | `HOLD_P0` | package-identity natural RED closed by a focused 26-case GREEN candidate; PR #25 remains HOLD and no release commit is admitted yet | launcher lifecycle/remaining P0 gates and #16 app artifact required |
