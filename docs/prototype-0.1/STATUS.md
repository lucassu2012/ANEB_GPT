...
|---:|---|---|---|---|
| #13 | current PMO conversation | `IN_PROGRESS` | G0/G1 integrated; PR #29/#30/#32/#34/#35/#37/#38/#39 and release P0 work coordinated | G2 exit evidence in progress; G3–G6 pending |
...
| #16 | ANEB_GPT Android | `IN_PROGRESS` | exact projector merged by PR #29; `done` fixture/decoder by PR #30; stream adapter by PR #32; CI bootstrap by PR #35; raw POST/SSE seam by PR #34; transport bridge by PR #37; 122-frame topology by PR #38; content sequence by PR #39; remote Android/Go/AI checks GREEN | content-event campaign/run identity is next; clock, terminal receipt, metrics, Room, UI, campaign orchestration and G2 exit evidence pending |
...
transport bridge, strict 122-frame topology and content sequence are merged. The
next bounded atom is content-event campaign/run identity consistency; clock,
...
1. continue issue #16 from PR #39 merge `a94a2d734b47ea8d445c3548ca8751e5856277b9` with a fresh natural RED for content-event campaign/run identity, then proceed in dependency order to clock and terminal receipt before metrics, Room, UI or campaign orchestration;
