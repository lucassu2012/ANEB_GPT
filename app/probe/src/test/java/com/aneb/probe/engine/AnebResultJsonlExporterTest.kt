...
class AnebResultJsonlExporterTest {
    @Test fun sortsAndEmitsExactStoredBodies() {
        val later = record("00000000-0000-7000-8000-000000000002", 2_000L)
        val earlier = record("00000000-0000-7000-8000-000000000001", 1_000L)
    ...
    private fun record(runId: String, startedAt: Long): ResultEnvelopeEntity {
        val body = """{"schema_version":"aneb-result-v1","test_type":"token_simulation","run":{"run_id":"$runId"}}"""
        return ResultEnvelopeEntity(
            runId = runId,
            schemaVersion = "aneb-result-v1",
            testType = "token_simulation",
