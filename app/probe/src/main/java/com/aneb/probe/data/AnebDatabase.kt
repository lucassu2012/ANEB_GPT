...
abstract class AnebDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        internal val MIGRATION_13_14_SQL = listOf(
            "CREATE TABLE IF NOT EXISTS `realtime_simulation_result` (" +
                "`runId` TEXT NOT NULL, " +
                "`startedAtEpochMs` INTEGER NOT NULL, " +
                "`serverBase` TEXT NOT NULL, " +
                "`claimScope` TEXT NOT NULL, " +
                ...
                "`evidenceJson` TEXT NOT NULL, " +
                "PRIMARY KEY(`runId`))",
            "CREATE INDEX IF NOT EXISTS `index_realtime_simulation_result_startedAtEpochMs` " +
                "ON `realtime_simulation_result` (`startedAtEpochMs`)",
        )
        ...
        internal val MIGRATION_14_15_SQL = listOf(
            "CREATE TABLE IF NOT EXISTS `network_comprehensive_result` (" +
                "`runId` TEXT NOT NULL, `startedAtEpochMs` INTEGER NOT NULL, " +
                "`serverBase` TEXT NOT NULL, `claimScope` TEXT NOT NULL, " +
                "`profileId` TEXT NOT NULL, `profileVersion` TEXT NOT NULL, `variant` TEXT NOT NULL, " +
                "`scorePolicyId` TEXT NOT NULL, `scoreAnchorPolicyId` TEXT NOT NULL, `conclusionPolicyId` TEXT NOT NULL, " +
                "`status` TEXT NOT NULL, `totalScore` REAL, `grade` TEXT, `verdict` TEXT NOT NULL, `confidence` TEXT NOT NULL, " +
                "`downloadMbps` REAL, `uploadMbps` REAL, `idleRttMs` REAL, `loadedRttMs` REAL, " +
                "`latencyDeltaMs` REAL, `jitterMs` REAL, `requestLossRate` REAL, `throughputRobustCv` REAL, " +
                "`udpNonReturnRate` REAL, `postLoadPingMs` REAL, `downloadBytes` INTEGER NOT NULL, `uploadBytes` INTEGER NOT NULL, " +
                "`transferErrors` TEXT NOT NULL, `metricsJson` TEXT NOT NULL, `groupScoresJson` TEXT NOT NULL, " +
                "`conclusionsJson` TEXT NOT NULL, `evidenceJson` TEXT NOT NULL, PRIMARY KEY(`runId`))",
            "CREATE INDEX IF NOT EXISTS `index_network_comprehensive_result_startedAtEpochMs` " +
