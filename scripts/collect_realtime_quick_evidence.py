...
v4="$(iptables-save | hash_stream)"
v6="$(ip6tables-save | hash_stream)"
nft_sha="$(nft --stateless list ruleset | hash_stream)"
full="$({ iptables-save; ip6tables-save; nft --stateless list ruleset; } | hash_stream)"
docker="$({
